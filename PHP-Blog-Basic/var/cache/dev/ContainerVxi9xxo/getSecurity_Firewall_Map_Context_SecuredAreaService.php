...
return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 2 => ${($_ = isset($this->services['security.logout_listener.secured_area']) ? $this->services['security.logout_listener.secured_area'] : $this->load(__DIR__.'/getSecurity_LogoutListener_SecuredAreaService.php')) && false ?: '_'};
    yield 3 => ${($_ = isset($this->services['security.authentication.listener.form.secured_area']) ? $this->services['security.authentication.listener.form.secured_area'] : $this->load(__DIR__.'/getSecurity_Authentication_Listener_Form_SecuredAreaService.php')) && false ?: '_'};
    yield 4 => ${($_ = isset($this->services['security.authentication.listener.anonymous.secured_area']) ? $this->services['security.authentication.listener.anonymous.secured_area'] : $this->load(__DIR__.'/getSecurity_Authentication_Listener_Anonymous_SecuredAreaService.php')) && false ?: '_'};
